...
public class ReceptionDashBordController  implements Initializable {
    ...
    @FXML
    public void customerOrderForm(ActionEvent actionEvent) throws IOException {
        AnchorPane an=FXMLLoader.load(this.getClass().getResource("/lk/ijse/student/dinemoreSystem/view/Reception/CustomerOrderForm.fxml"));
        mainPane.getChildren().add(an);
    }
}
