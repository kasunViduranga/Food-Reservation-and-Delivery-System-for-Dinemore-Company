...
public class DeliverDashBoardController implements Initializable {
    ...
    @FXML
    public void manageOrder(ActionEvent actionEvent) throws IOException {
        AnchorPane an=FXMLLoader.load(this.getClass().getResource("/lk/ijse/student/dinemoreSystem/view/DiliverView/CustomerOrderDeliver.fxml"));
        mainPane.getChildren().add(an);
    }
}
